...
kubectl --kubeconfig=${CLUSTERS_DIR}/us-west1.kubeconfig describe nodes >>us-west1.log 2>&1
kubectl --kubeconfig=${CLUSTERS_DIR}/us-west1.kubeconfig get deployment my-deployment--us-west1 -o yaml -n demo >>us-west1.log 2>&1
kubectl --kubeconfig=${CLUSTERS_DIR}/us-west1.kubeconfig describe pods -n demo >>us-west1.log 2>&1
kubectl --kubeconfig=${CLUSTERS_DIR}/us-west1.kubeconfig describe nodes >>us-east1.log 2>&1
kubectl --kubeconfig=${CLUSTERS_DIR}/us-east1.kubeconfig get deployment my-deployment--us-east1 -o yaml -n demo >>us-east1.log 2>&1
kubectl --kubeconfig=${CLUSTERS_DIR}/us-east1.kubeconfig describe pods -n demo >>us-east1.log 2>&1
